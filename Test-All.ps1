...
foreach($name in @('Test-ProgramFamilyRouting.ps1','Test-ProgramCleanStart.ps1','Test-CleanStartWorker.ps1','Test-DesktopBranding.ps1','Test-ProgramFamilyTracking.ps1','Test-ManagedRouting.ps1','Test-ManagedLaunchEvidence.ps1','Test-ManagedObservation.ps1','Test-ManagedRemoval.ps1','Test-ProxySwitch.ps1','Test-Preferences.ps1','Test-ProgramIdentity.ps1','Test-ApplicationObservation.ps1','Test-RuleMaintenance.ps1','Test-WorkerOutcome.ps1','Test-EntryMaintenance.ps1','Test-ProxyDiscovery.ps1','Test-Compatibility.ps1','Test-AutomaticDiscovery.ps1','Test-ProgramLaunch.ps1','Test-Storage.ps1','Test-GatewayControl.ps1','Test-ExitRecovery.ps1','Test-NetworkDiagnostics.ps1','Test-DeadEntryRepair.ps1','Test-Watchdog.ps1','Test-StatusSnapshot.ps1','Test-FailoverDisplay.ps1','Test-LifecycleProtection.ps1')){
