...
$files=@(
    ...
    'config.defaults.json','启动代理切换.cmd','Install-Shortcut.ps1','Test-All.ps1','Test-GatewayLock.cjs','Test-WindowInstance.ps1','Test-Lifecycle.cjs','Test-LifecycleProtection.ps1','Test-TrayLifecycle.ps1','Test-SupervisorRecovery.ps1','Test-IndependentRouter.cjs','Test-IndependentIntegration.cjs','Test-ExitRecovery.ps1','Test-NetworkDiagnostics.ps1','Test-Watchdog.ps1','Test-GatewayControl.ps1','Test-GatewayIntegration.cjs','Test-ProxySwitch.ps1','Test-AppRouter.cjs','Test-Preferences.ps1','Test-ProxyDiscovery.ps1',
